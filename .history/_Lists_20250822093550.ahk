...
class ResponsiveListManager {
  ...
  ConfigureListView() {
    ...
    availableWidth := ResponsiveListManager.LEFT_PANEL_WIDTH - 25  ; Account for vertical scrollbar and borders

    col1Width := 25
    col2Width := 75
    col4Width := 15   ; More spacing for better header appearance
    col3Width := availableWidth - col1Width - col2Width - col4Width  ; Use remaining space
