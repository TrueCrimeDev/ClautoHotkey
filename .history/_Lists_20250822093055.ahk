...
class ResponsiveListManager {
  ...
  ConfigureListView() {
    ...
    ; Calculate column widths to fit within ListView width (account for vertical scrollbar)
    col1Width := 25
    col2Width := 85
    col3Width := 140
    col4Width := ResponsiveListManager.LEFT_PANEL_WIDTH - col1Width - col2Width - col3Width - 20  ; Fill remaining space
