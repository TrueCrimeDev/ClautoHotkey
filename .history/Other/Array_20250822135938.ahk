...
class ArrayDemoGui {
  ...
  CreateGUI() {
    ...
    this.gui.AddText("xm y+10 Section", "Presets:")
    this.controls["emptyBtn"] := this.gui.AddButton("xm w95", "Empty")
    this.controls["emptyBtn"].OnEvent("Click", this.LoadPresetHandler.Bind(this, "Empty"))

    this.controls["fruitsBtn"] := this.gui.AddButton("x+5 w95", "Fruits")
    this.controls["fruitsBtn"].OnEvent("Click", this.LoadPresetHandler.Bind(this, "Fruits"))

    this.controls["mixedBtn"] := this.gui.AddButton("x+5 w95", "Mixed")
    this.controls["mixedBtn"].OnEvent("Click", this.LoadPresetHandler.Bind(this, "Mixed"))

    this.controls["numbersBtn"] := this.gui.AddButton("x+5 w95", "Numbers")
    this.controls["numbersBtn"].OnEvent("Click", this.LoadPresetHandler.Bind(this, "Numbers"))

    this.controls["gapsBtn"] := this.gui.AddButton("x+5 w95", "With Gaps")
    this.controls["gapsBtn"].OnEvent("Click", this.LoadPresetHandler.Bind(this, "With Gaps"))

    this.gui.AddText("xm y+15 Section", "Transform Operations:")
    this.controls["mapBtn"] := this.gui.AddButton("xm w120", "Map (x*2)")
    this.controls["mapBtn"].OnEvent("Click", this.DoMap.Bind(this))

    this.controls["filterBtn"] := this.gui.AddButton("x+5 w120", "Filter (>5)")
    this.controls["filterBtn"].OnEvent("Click", this.DoFilter.Bind(this))

    this.controls["uniqueBtn"] := this.gui.AddButton("x+5 w120", "Unique")
    this.controls["uniqueBtn"].OnEvent("Click", this.DoUnique.Bind(this))

    this.controls["reverseBtn"] := this.gui.AddButton("x+5 w120", "Reverse")
    this.controls["reverseBtn"].OnEvent("Click", this.DoReverse.Bind(this))

    this.gui.AddText("xm y+15 Section", "Aggregate Operations:")
    this.controls["sumBtn"] := this.gui.AddButton("xm w95", "Sum")
    this.controls["sumBtn"].OnEvent("Click", this.DoSum.Bind(this))

    this.controls["avgBtn"] := this.gui.AddButton("x+5 w95", "Average")
    this.controls["avgBtn"].OnEvent("Click", this.DoAverage.Bind(this))

    this.controls["minBtn"] := this.gui.AddButton("x+5 w95", "Min")
    this.controls["minBtn"].OnEvent("Click", this.DoMin.Bind(this))

    this.controls["maxBtn"] := this.gui.AddButton("x+5 w95", "Max")
    this.controls["maxBtn"].OnEvent("Click", this.DoMax.Bind(this))

    this.controls["reduceBtn"] := this.gui.AddButton("x+5 w95", "Product")
    this.controls["reduceBtn"].OnEvent("Click", this.DoProduct.Bind(this))

    this.gui.AddText("xm y+15 Section", "Search Operations:")
    this.controls["searchEdit"] := this.gui.AddEdit("xm w120", "3")

    this.controls["findBtn"] := this.gui.AddButton("x+5 w120", "Find (>n)")
    this.controls["findBtn"].OnEvent("Click", this.DoFind.Bind(this))

    this.controls["indexBtn"] := this.gui.AddButton("x+5 w120", "IndexOf")
    this.controls["indexBtn"].OnEvent("Click", this.DoIndexOf.Bind(this))

    this.controls["containsBtn"] := this.gui.AddButton("x+5 w120", "Contains")
    this.controls["containsBtn"].OnEvent("Click", this.DoContains.Bind(this))

    this.gui.AddText("xm y+15 Section", "Join Operation:")
    this.controls["delimiterEdit"] := this.gui.AddEdit("xm w120", ", ")

    this.controls["joinBtn"] := this.gui.AddButton("x+5 w120", "Join")
    this.controls["joinBtn"].OnEvent("Click", this.DoJoin.Bind(this))

    this.gui.AddText("xm y+15 Section", "Current Array Visualization:")
