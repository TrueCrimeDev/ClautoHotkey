...
class ResponsiveListManager {
  ...
  CreateHeaderSection() {
    ...
    buttonY := currentY + ResponsiveListManager.CONTROL_HEIGHT + 5
    ...
    buttonX := margin + ResponsiveListManager.ICON_BTN_SIZE + ResponsiveListManager.BUTTON_GAP
    ...
    searchX := buttonX + ResponsiveListManager.ICON_BTN_SIZE + ResponsiveListManager.BUTTON_GAP
    searchWidth := margin + ResponsiveListManager.LEFT_PANEL_WIDTH - searchX
    ...
    this.layout["headerHeight"] := ResponsiveListManager.CONTROL_HEIGHT + 5 + ResponsiveListManager.CONTROL_HEIGHT
  }
