...
The main directory of the project you're working on is here: %USERPROFILE%\OneDrive\Documents\Cline\MCP\ahk-server

The summary log of the most recent MCP activity can be found here: %APPDATA%\Claude\logs\ahk-server-summary.log
