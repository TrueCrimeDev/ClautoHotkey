...
class ConfigManager {
    ...
    static GetInstance(configPath := "") {
        if !ConfigManager._instance {
            ...
            ; Create instance with the right pattern for AHK v2
            ConfigManager._instance := {}
            ConfigManager.Prototype.__Init(ConfigManager._instance, configPath)
        }
...
try {
    ...
    ; Create and show UI
    ui := UserInterface.Prototype.__Init(Map(), configManager)
    ui.Show()
} catch Error as e {
