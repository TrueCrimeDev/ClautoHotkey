...
1. Load the full reference from `${CLAUDE_PLUGIN_ROOT}/Modules/Module_WinAPI.md` — messages, subclassing, owner-draw, DWM, WinRT activation.
...
For the DWM constants, subclass lifetime rules, and the WinRT clipboard-history example, read `${CLAUDE_PLUGIN_ROOT}/Modules/Module_WinAPI.md`.
