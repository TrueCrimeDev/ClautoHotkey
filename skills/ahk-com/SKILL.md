...
1. Load the full reference from `${CLAUDE_PLUGIN_ROOT}/Modules/Module_COM.md` — creation, events, ComValue, SafeArrays, vtable ComCall.
...
For events, SafeArrays, the VARENUM table, and cleanup rules, read `${CLAUDE_PLUGIN_ROOT}/Modules/Module_COM.md`.
