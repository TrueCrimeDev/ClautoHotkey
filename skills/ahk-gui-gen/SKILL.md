...
2. **Read** `${CLAUDE_PLUGIN_ROOT}/Modules/Module_GUI.md` — construction, controls, events, the Positioning Options
...
6. **Observe** (optional): run the GUI, then capture it with `${CLAUDE_PLUGIN_ROOT}/Tools/CaptureWindow.ahk` —
